...
class MicrosoftGraphEmailProviderPlaceholder implements EmailProviderInterface
{
    /**
    ...
    {
        throw NotConfiguredYetException::forAdapter('microsoft_graph_email_provider');
    }
