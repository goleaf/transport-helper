...
use App\Http\Controllers\Supply\MasterDataChangeDecisionController;
use App\Http\Controllers\Supply\MasterDataChangeRequestController;
use App\Http\Controllers\Supply\MasterDataDashboardController;
use App\Http\Controllers\Supply\MasterDataMergeExecutionController;
use App\Http\Controllers\Supply\MasterDataMergeProposalController;
use App\Http\Controllers\Supply\MasterDataQualityReportController;
...
use App\Http\Controllers\Supply\ProductAliasController;
use App\Http\Controllers\Supply\ProductLifecycleController;
...
use App\Http\Controllers\Supply\DataStewardAssignmentController;
use App\Http\Controllers\Supply\SupplierConfirmationController;
use App\Http\Controllers\Supply\SupplierController;
use App\Http\Controllers\Supply\SupplierAliasController;
use App\Http\Controllers\Supply\SupplierLifecycleController;
...
use App\Http\Controllers\Supply\SupplierProductIdentityController;
...
use App\Http\Controllers\Supply\UnknownSkuResolutionController;
...
Route::middleware(['web', 'auth'])
    ...
    ->group(function (): void {
        ...
        Route::get('master-data', MasterDataDashboardController::class)->name('master-data.dashboard');
        Route::get('master-data/product-aliases', [ProductAliasController::class, 'index'])->name('master-data.product-aliases.index');
        Route::post('master-data/product-aliases', [ProductAliasController::class, 'store'])->name('master-data.product-aliases.store');
        Route::get('master-data/supplier-aliases', [SupplierAliasController::class, 'index'])->name('master-data.supplier-aliases.index');
        Route::post('master-data/supplier-aliases', [SupplierAliasController::class, 'store'])->name('master-data.supplier-aliases.store');
        Route::get('master-data/supplier-product-identities', [SupplierProductIdentityController::class, 'index'])->name('master-data.supplier-product-identities.index');
        Route::post('master-data/supplier-product-identities', [SupplierProductIdentityController::class, 'store'])->name('master-data.supplier-product-identities.store');
        Route::get('master-data/unknown-skus', [UnknownSkuResolutionController::class, 'index'])->name('master-data.unknown-skus.index');
        Route::get('master-data/unknown-skus/{resolution}', [UnknownSkuResolutionController::class, 'show'])->name('master-data.unknown-skus.show');
        Route::post('master-data/unknown-skus', [UnknownSkuResolutionController::class, 'store'])->name('master-data.unknown-skus.store');
        Route::post('master-data/unknown-skus/{resolution}/resolve', [UnknownSkuResolutionController::class, 'resolve'])->name('master-data.unknown-skus.resolve');
        Route::post('master-data/unknown-skus/{resolution}/ignore', [UnknownSkuResolutionController::class, 'ignore'])->name('master-data.unknown-skus.ignore');
        Route::get('master-data/change-requests', [MasterDataChangeRequestController::class, 'index'])->name('master-data.change-requests.index');
        Route::post('master-data/change-requests', [MasterDataChangeRequestController::class, 'store'])->name('master-data.change-requests.store');
        Route::get('master-data/change-requests/{changeRequest}', [MasterDataChangeRequestController::class, 'show'])->name('master-data.change-requests.show');
        Route::post('master-data/change-requests/{changeRequest}/approve', [MasterDataChangeDecisionController::class, 'approve'])->name('master-data.change-requests.approve');
        Route::post('master-data/change-requests/{changeRequest}/reject', [MasterDataChangeDecisionController::class, 'reject'])->name('master-data.change-requests.reject');
        Route::post('master-data/change-requests/{changeRequest}/apply', [MasterDataChangeDecisionController::class, 'apply'])->name('master-data.change-requests.apply');
        Route::get('master-data/merge-proposals', [MasterDataMergeProposalController::class, 'index'])->name('master-data.merge-proposals.index');
        Route::post('master-data/merge-proposals', [MasterDataMergeProposalController::class, 'store'])->name('master-data.merge-proposals.store');
        Route::get('master-data/merge-proposals/{proposal}', [MasterDataMergeProposalController::class, 'show'])->name('master-data.merge-proposals.show');
        Route::post('master-data/merge-proposals/{proposal}/approve', [MasterDataMergeProposalController::class, 'approve'])->name('master-data.merge-proposals.approve');
        Route::post('master-data/merge-proposals/{proposal}/reject', [MasterDataMergeProposalController::class, 'reject'])->name('master-data.merge-proposals.reject');
        Route::post('master-data/merge-proposals/{proposal}/execute', [MasterDataMergeExecutionController::class, 'store'])->name('master-data.merge-proposals.execute');
        Route::post('master-data/products/{product}/lifecycle', [ProductLifecycleController::class, 'store'])->name('master-data.products.lifecycle');
        Route::post('master-data/suppliers/{supplier}/lifecycle', [SupplierLifecycleController::class, 'store'])->name('master-data.suppliers.lifecycle');
        Route::get('master-data/stewards', [DataStewardAssignmentController::class, 'index'])->name('master-data.stewards.index');
        Route::post('master-data/stewards', [DataStewardAssignmentController::class, 'store'])->name('master-data.stewards.store');
        Route::get('master-data/reports/quality', [MasterDataQualityReportController::class, 'index'])->name('master-data.reports.quality');
        Route::post('master-data/reports/quality/export', [MasterDataQualityReportController::class, 'export'])->name('master-data.reports.quality.export');
