<section>
    ...
    <div class="proposal-timeline" aria-label="T0 T1 T2 T3 timeline">
        <div class="card bg-base-100 border border-base-300 shadow-sm proposal-timeline-node">
            <strong>T0</strong>
    ...
    <div class="proposal-periods">
        <div class="alert alert-info proposal-period">T0-T1: order execution period</div>
        <div class="alert alert-info proposal-period">T1-T2: planned coverage period</div>
        <div class="alert alert-info proposal-period">T2-T3: safety horizon</div>
    </div>
